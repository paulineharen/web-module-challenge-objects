...
function getReviewByIndex (reviews, index) {
  ...
  const reviewGrab = console.log(`${reviews[index].name} gave the restaurant a ${reviews[index].rating} star review and their feedback was: ${reviews[index].feedback}`);
  }
...
*/
function getLastReview(retrieveLast) {
  const lastIndex= retrieveLast.length -1;
  return `${retrieveLast[lastIndex].name} gave the restaurant a ${retrieveLast[lastIndex].rating}, and their feedback was: ${retrieveLast[lastIndex].feedback}`;
}
